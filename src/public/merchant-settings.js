...
var initialConfig = {
    private: {
        merchantId: "",
        APIsecret: "",
        endpointUrl: "https://merchant.revolut.com/api/1.0/orders",
        installed: "yes"
    },
    public: {}
};
...
let storeId, accessToken, language, viewMode, publicToken, appState;
...
function initApp() {
    ...
    language = storeData.lang;
    viewMode = storeData.view_mode;
    if (storeData.public_token !== undefined) {
        publicToken = storeData.public_token;
    }
    if (storeData.app_state !== undefined) {
        appState = storeData.app_state;
    }
